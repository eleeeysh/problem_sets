...
author: "Tobi Gerstenberg, edited by Bria Long for Psych 201a/CSS 204"
format: html
editor: visual
---
...
Now, let's load the packages that we need for these excercise
...
ggplot(data = df.diamonds[1:10000,],
       mapping = aes(x = cut,
                     y = price)) +
  geom_violin() + 
